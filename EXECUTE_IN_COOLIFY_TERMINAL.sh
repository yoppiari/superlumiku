#!/bin/bash
# ============================================
# COPY-PASTE THIS INTO COOLIFY TERMINAL
# ============================================
# This script executes the Avatar Creator migration
# directly inside the container via Coolify UI Terminal
#
# Instructions:
...
echo "Starting Avatar Creator Migration..."
echo "===================================="
echo ""

# Create migration SQL file directly in container
cat > /tmp/avatar_migration.sql << 'EOFMIGRATION'
-- Avatar Creator & Pose Generator Migration
...
-- 2. avatars (WITH PERSONA FIELDS - CRITICAL!)
...
ALTER TABLE "avatars" ADD CONSTRAINT "avatars_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "avatar_projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "avatar_usage_history" ADD CONSTRAINT "avatar_usage_history_avatarId_fkey" FOREIGN KEY ("avatarId") REFERENCES "avatars"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- 6. avatar_generations
...
ALTER TABLE "pose_categories" ADD CONSTRAINT "pose_categories_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "pose_categories"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "pose_library" ADD CONSTRAINT "pose_library_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "pose_categories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- 9. pose_generator_projects
...
ALTER TABLE "pose_generator_projects" ADD CONSTRAINT "pose_generator_projects_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "pose_generator_projects" ADD CONSTRAINT "pose_generator_projects_avatarId_fkey" FOREIGN KEY ("avatarId") REFERENCES "avatars"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "pose_generations" ADD CONSTRAINT "pose_generations_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "pose_generator_projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "pose_generations" ADD CONSTRAINT "pose_generations_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "pose_generations" ADD CONSTRAINT "pose_generations_avatarId_fkey" FOREIGN KEY ("avatarId") REFERENCES "avatars"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "generated_poses" ADD CONSTRAINT "generated_poses_generationId_fkey" FOREIGN KEY ("generationId") REFERENCES "pose_generations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "generated_poses" ADD CONSTRAINT "generated_poses_poseLibraryId_fkey" FOREIGN KEY ("poseLibraryId") REFERENCES "pose_library"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "pose_selections" ADD CONSTRAINT "pose_selections_generationId_fkey" FOREIGN KEY ("generationId") REFERENCES "pose_generations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "pose_selections" ADD CONSTRAINT "pose_selections_poseLibraryId_fkey" FOREIGN KEY ("poseLibraryId") REFERENCES "pose_library"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "pose_requests" ADD CONSTRAINT "pose_requests_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "pose_requests" ADD CONSTRAINT "pose_requests_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "pose_categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;
EOFMIGRATION

echo "Migration SQL file created at: /tmp/avatar_migration.sql"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    psql "$DATABASE_URL" -c "SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND (table_name LIKE 'avatar%' OR table_name LIKE 'pose%' OR table_name LIKE 'persona%' OR table_name LIKE 'generated%') ORDER BY table_name;"
    ...
    echo ""
    echo "Tables created:"
    echo "  1. avatar_projects"
    echo "  2. avatars (with persona fields)"
    echo "  3. avatar_presets"
    echo "  4. persona_examples"
    echo "  5. avatar_usage_history"
    echo "  6. avatar_generations"
    echo "  7. pose_categories"
    echo "  8. pose_library"
    echo "  9. pose_generator_projects"
    echo " 10. pose_generations"
    echo " 11. generated_poses"
    echo " 12. pose_selections"
    echo " 13. pose_requests"
    echo ""
    echo "Next: Restart the container from Coolify UI"
else
    echo ""
