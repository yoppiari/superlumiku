...
export const seedAIModels = async () => {
  ...
  const models = [
    ...
    // ==========================================
    // PHOTOMAKER V2 MODELS (Identity-Preserving)
    // ==========================================
    {
      appId: 'avatar-creator',
      modelId: 'photomaker-basic',
      modelKey: 'avatar-creator:photomaker-basic',
      name: 'PhotoMaker V2 Basic',
      description: 'Identity-preserving photo-to-avatar generation with PhotoMaker V2 (no training needed, 512x512)',
      provider: 'tencent',
      tier: 'basic',
      creditCost: 18,
      creditPerPixel: null,
      ...
      capabilities: JSON.stringify({
        ...
        processingTime: '60-90s',
        photoRealistic: true,
        features: ['photo-to-avatar', 'identity-preservation', 'zero-shot', 'no-training', 'multi-photo']
      }),
      enabled: true,
      beta: false
    },
    {
      appId: 'avatar-creator',
      modelId: 'photomaker-pro',
      modelKey: 'avatar-creator:photomaker-pro',
      name: 'PhotoMaker V2 Pro',
      description: 'Premium identity-preserving generation with PhotoMaker V2 at 1024x1024 for professional results',
      provider: 'tencent',
      tier: 'pro',
      creditCost: 25,
      creditPerPixel: null,
      ...
      capabilities: JSON.stringify({
        ...
        photoRealistic: true,
        ultraRealistic: true,
        features: ['photo-to-avatar', 'identity-preservation', 'zero-shot', 'high-res', 'professional-grade']
      }),
      enabled: true,
      beta: false
    },
    {
      appId: 'avatar-creator',
      modelId: 'photomaker-enterprise',
      modelKey: 'avatar-creator:photomaker-enterprise',
      name: 'PhotoMaker V2 Enterprise',
      description: 'Ultra-premium PhotoMaker V2 at maximum resolution (1536x1536) for studio-quality portraits',
      provider: 'tencent',
      tier: 'enterprise',
      creditCost: 35,
      creditPerPixel: null,
      ...
      capabilities: JSON.stringify({
        ...
        ultraRealistic: true,
        highResolution: true,
        features: ['photo-to-avatar', 'identity-preservation', 'zero-shot', 'ultra-hd', 'studio-quality', 'maximum-detail']
      }),
      enabled: true,
      beta: false
    }
